...
/// <summary>
/// Model for AI model list page using MVUX pattern.
/// Supports searching, sorting, and pagination.
/// </summary>
public partial record AiModelListModel
{
    private readonly IAiModelService _aiModelService;
    private readonly INavigator _navigator;
    private readonly IStringLocalizer _localizer;

    public AiModelListModel(
    ...
    /// </summary>
    public IListFeed<AiModelListDto> AiModels => Feed
        ...
        .SelectAsync(async (combined, ct) =>
        {
            ...
            await Pagination.UpdateAsync(_ => new AiModelPaginationInfo(
...
/// <summary>
/// Holds pagination state information for AI models.
/// </summary>
public record AiModelPaginationInfo
{
    private readonly IStringLocalizer? _localizer;
    ...
    /// <summary>
    /// Display text for total count info (e.g., "25 AI models").
    /// </summary>
    public string CountInfo
    {
        get
        {
            if (TotalCount == 1)
            {
                return _localizer?["Pagination.AiModelsSingular"] ?? "1 AI model";
            }

            var format = _localizer?["Pagination.AiModelsPlural"] ?? "{0} AI models";
