...
/// <summary>
/// Model for AI prompt list page using MVUX pattern.
/// Supports searching, sorting, and pagination.
/// </summary>
public partial record AiPromptListModel
{
    private readonly IAiPromptService _aiPromptService;
    private readonly INavigator _navigator;
    private readonly IStringLocalizer _localizer;

    public AiPromptListModel(
    ...
    /// <summary>
    /// Current sort order (e.g., "Identifier Ascending").
    /// </summary>
    public IState<string> SortOrder => State<string>.Value(this, () => "DateModified Descending");
    ...
    /// </summary>
    public IListFeed<AiPromptListDto> AiPrompts => Feed
        ...
        .SelectAsync(async (combined, ct) =>
        {
            ...
            var response = await _aiPromptService.GetAiPromptsAsync(parameters, ct);

            // Update pagination info
            await Pagination.UpdateAsync(_ => new AiPromptPaginationInfo(
...
/// <summary>
/// Holds pagination state information for AI prompts.
/// </summary>
public record AiPromptPaginationInfo
{
    private readonly IStringLocalizer? _localizer;
    ...
    /// <summary>
    /// Display text for total count info (e.g., "25 AI prompts").
    /// </summary>
    public string CountInfo
    {
        get
        {
            if (TotalCount == 1)
            {
                return _localizer?["Pagination.AiPromptsSingular"] ?? "1 AI prompt";
            }

            var format = _localizer?["Pagination.AiPromptsPlural"] ?? "{0} AI prompts";
