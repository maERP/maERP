...
/// </summary>
public class InvoiceUpdateHandler : IRequestHandler<InvoiceInputCommand, Result<int>>
{
    /// <summary>
    ...
    public async Task<Result<int>> Handle(InvoiceInputCommand request, CancellationToken cancellationToken)
    {
