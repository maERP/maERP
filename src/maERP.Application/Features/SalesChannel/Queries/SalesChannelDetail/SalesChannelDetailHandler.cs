...
public class SalesChannelDetailHandler : IRequestHandler<SalesChannelDetailQuery, SalesChannelDetailResponse>
{
    ...
    public async Task<SalesChannelDetailResponse> Handle(SalesChannelDetailQuery request, CancellationToken cancellationToken)
    {
