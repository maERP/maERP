...
public class DebugLogEntry
{
    public DebugLogEntry(DebugLevel level, string message, DateTime timestamp)
    {
        ...
        {
            DebugLevel.Debug => new SolidColorBrush(Windows.UI.Color.FromArgb(40, 128, 128, 128)),
            DebugLevel.Info => new SolidColorBrush(Windows.UI.Color.FromArgb(40, 0, 150, 255)),
            DebugLevel.Warning => new SolidColorBrush(Windows.UI.Color.FromArgb(40, 255, 193, 7)),
            DebugLevel.Error => new SolidColorBrush(Windows.UI.Color.FromArgb(40, 220, 53, 69)),
            _ => new SolidColorBrush(Windows.UI.Color.FromArgb(40, 128, 128, 128))
        };

        LevelForeground = level switch
        {
            DebugLevel.Debug => new SolidColorBrush(Windows.UI.Color.FromArgb(255, 128, 128, 128)),
            DebugLevel.Info => new SolidColorBrush(Windows.UI.Color.FromArgb(255, 0, 123, 255)),
            DebugLevel.Warning => new SolidColorBrush(Windows.UI.Color.FromArgb(255, 255, 193, 7)),
            DebugLevel.Error => new SolidColorBrush(Windows.UI.Color.FromArgb(255, 220, 53, 69)),
