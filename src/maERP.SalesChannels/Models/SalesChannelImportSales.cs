...
public class SalesChannelImportSales
{
    ...
    // Bestellpositionen (durch SalesItems ersetzen, da es im Repository verwendet wird)
    public ICollection<SalesChannelImportSalesItem> SalesItems { get; set; } = new List<SalesChannelImportSalesItem>();
