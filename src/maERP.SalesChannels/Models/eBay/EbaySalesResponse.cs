...
public class EbaySalesResponse
{
    [JsonPropertyName("salesId")]
    public string SalesId { get; set; }

    [JsonPropertyName("legacySalesId")]
    public string LegacySalesId { get; set; }
    ...
    [JsonPropertyName("salesFulfillmentStatus")]
    public string SalesFulfillmentStatus { get; set; }

    [JsonPropertyName("salesPaymentStatus")]
    public string SalesPaymentStatus { get; set; }
