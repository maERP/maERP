...
namespace maERP.Server.Data.SalesChannelData.Shopware5
{
	public class Shopware5Product
	{
        ...
        public class ShopwareProductAttribute
        {
            public int id { get; set; }
        ...
        public class ShopwareProductDetail
        {
            public int id { get; set; }
            ...
            public ShopwareProductAttribute attribute { get; set; }
        }
        ...
        public class ShopwareProduct
        {
            ...
            public ShopwareProductDetail mainDetail { get; set; }
        }

        public class ShopwareProductListResponse
        {
            public List<ShopwareProduct> data { get; set; }
