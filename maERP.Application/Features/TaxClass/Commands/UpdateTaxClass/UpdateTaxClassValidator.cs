...
public class UpdateTaxClassValidator : AbstractValidator<UpdateTaxClassCommand>
{
    private readonly ITaxClassRepository _taxClassRepository;

    public UpdateTaxClassValidator(ITaxClassRepository taxClassRepository)
    {
    ...
    {
        var taxClass = new Domain.Models.TaxClass
        {
