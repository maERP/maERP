...
public class GetWarehousesQueryHandler : IRequestHandler<GetWarehousesQuery, List<WarehouseListDto>>
{
    ...
    private readonly IAppLogger<GetWarehousesQueryHandler> _logger;
    private readonly IWarehouseRepository _warehouseRepository;

    public GetWarehousesQueryHandler(IMapper mapper,
        IAppLogger<GetWarehousesQueryHandler> logger, 
