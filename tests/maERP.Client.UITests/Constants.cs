namespace maERP.Client.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "de.martinandrich.maERP.Client";
    public readonly static string AndroidAppName = "de.martinandrich.maERP.Client";
