...
public class TenantDeleteCommandTests : TenantIsolatedTestBase
{
    ...
    public async Task DeleteTenant_WithoutAuthentication_ShouldReturnUnauthorized()
    {
        ...
        var response = await Client.DeleteAsync($"/api/v1/Tenants/{TenantConstants.TestTenant1Id}");
    ...
    public async Task DeleteTenant_WithNonExistentId_ShouldReturnBadRequestWhenAuthenticated()
    {
        ...
        var response = await Client.DeleteAsync($"/api/v1/Tenants/{nonExistentId}");
    ...
    public async Task DeleteTenant_WithInvalidGuidFormat_ShouldReturnNotFound()
    {
        ...
        var response = await Client.DeleteAsync("/api/v1/Tenants/invalid-guid");
    ...
    public async Task DeleteTenant_WithValidGuid_ShouldHandleCorrectly()
    {
        ...
        var response = await Client.DeleteAsync($"/api/v1/Tenants/{TenantConstants.TestTenant2Id}");
    ...
    public async Task DeleteTenant_MultipleCallsSameId_ShouldHandleCorrectly()
    {
        ...
        var response1 = await Client.DeleteAsync($"/api/v1/Tenants/{TenantConstants.TestTenant1Id}");
        ...
        var response2 = await Client.DeleteAsync($"/api/v1/Tenants/{TenantConstants.TestTenant1Id}");
