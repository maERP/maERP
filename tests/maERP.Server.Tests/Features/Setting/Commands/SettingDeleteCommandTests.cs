...
public class SettingDeleteCommandTests : IDisposable
{
    ...
    private async Task<int> CreateTestSettingAsync(int tenantId, string key = "test.delete.key", string value = "delete_value")
    {
    ...
    {
        await SeedTestDataAsync();
        var settingId = await CreateTestSettingAsync(1, "test.delete.persist", "persistent_value");
        SetTenantHeader(1);
    ...
    public async Task DeleteSetting_WithNonExistentId_ShouldReturnNotFound()
    {
        ...
        var response = await Client.DeleteAsync("/api/v1/Settings/999999");
    ...
    {
        await SeedTestDataAsync();
        var tenant1SettingId = await CreateTestSettingAsync(1, "isolation.delete.test", "tenant1_value");
        var tenant2SettingId = await CreateTestSettingAsync(2, "isolation.delete.test", "tenant2_value");
    ...
    {
        await SeedTestDataAsync();
        var setting1Id = await CreateTestSettingAsync(1, "multi.delete.test1", "value1");
        var setting2Id = await CreateTestSettingAsync(1, "multi.delete.test2", "value2");
        var setting3Id = await CreateTestSettingAsync(1, "multi.delete.test3", "value3");
    ...
    public async Task DeleteSetting_WithZeroId_ShouldReturnNotFound()
    {
        ...
        var response = await Client.DeleteAsync("/api/v1/Settings/0");
    ...
    public async Task DeleteSetting_WithNegativeId_ShouldReturnNotFound()
    {
        ...
        var response = await Client.DeleteAsync("/api/v1/Settings/-1");
    ...
    public async Task DeleteSetting_WithLargeId_ShouldReturnNotFound()
    {
        ...
        var response = await Client.DeleteAsync("/api/v1/Settings/2147483647"); // Max int value
    ...
    {
        await SeedTestDataAsync();
        var settingId = await CreateTestSettingAsync(1, "database.consistency.test", "consistency_value");
        SetTenantHeader(1);
    ...
    public async Task DeleteSetting_AfterMultipleOperations_ShouldMaintainConsistency()
    {
        ...
        // Create a setting
        var settingId = await CreateTestSettingAsync(1, "operations.test", "original_value");
    ...
    {
        await SeedTestDataAsync();
        var tenant1SettingId = await CreateTestSettingAsync(1, "cross.tenant.delete", "tenant1_value");
        var tenant2SettingId = await CreateTestSettingAsync(2, "cross.tenant.delete", "tenant2_value");
