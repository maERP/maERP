...
public class TaxClassListQueryTests : TenantIsolatedTestBase
{
    ...
    [Fact]
    public async Task GetTaxClassList_WithNonExistentTenant_ShouldReturnEmptyPaginatedResult()
    {
        // Arrange
        await SeedTestDataAsync();
        await CreateTestTaxClassAsync(TenantConstants.TestTenant1Id);
    ...
    [Fact]
    public async Task GetTaxClassList_WithEmptyTenantHeaderValue_ShouldReturnEmptyResult()
    {
        // Arrange
        await SeedTestDataAsync();
        await CreateTestTaxClassAsync(TenantConstants.TestTenant1Id);
