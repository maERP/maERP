...
public class AssignUserToTenantCommandTests : IDisposable
{
    ...
    public async Task AssignUserToTenant_WithValidData_ShouldSucceed()
    {
        ...
        var response = await PostAsJsonAsync($"/api/v1/superadmin/users/{userId1}/tenants", command);
    ...
    public async Task AssignUserToTenant_WithNonExistentUser_ShouldFail()
    {
        ...
        var response = await PostAsJsonAsync($"/api/v1/superadmin/users/{nonExistentUserId}/tenants", command);
    ...
    public async Task AssignUserToTenant_WithExistingAssignment_ShouldFail()
    {
        ...
        var response = await PostAsJsonAsync($"/api/v1/superadmin/users/{userId2}/tenants", command);
    ...
    public async Task AssignUserToTenant_WithDefaultFlag_ShouldUpdateExistingDefaults()
    {
        ...
        var response1 = await PostAsJsonAsync($"/api/v1/superadmin/users/{userId2}/tenants", command1);
        ...
        var response2 = await PostAsJsonAsync($"/api/v1/superadmin/users/{userId2}/tenants", command2);
    ...
    public async Task AssignUserToTenant_WithInvalidUserId_ShouldFail()
    {
        ...
        var response = await PostAsJsonAsync("/api/v1/superadmin/users/invalid-user-id/tenants", command);
    ...
    public async Task AssignUserToTenant_MultipleAssignments_ShouldAllowMultipleNonDefaultTenants()
    {
        ...
        var response1 = await PostAsJsonAsync($"/api/v1/superadmin/users/{userId1}/tenants", command1);
        TestAssertions.AssertHttpStatusCode(response1, HttpStatusCode.Created);

        // Assign to tenant 2 (non-default)
        var command2 = CreateValidAssignCommand(userId1, TenantConstants.TestTenant2Id, false);
        var response2 = await PostAsJsonAsync($"/api/v1/superadmin/users/{userId1}/tenants", command2);
        TestAssertions.AssertHttpStatusCode(response2, HttpStatusCode.Created);

        // Assign to tenant 3 (default)
        var command3 = CreateValidAssignCommand(userId1, TenantConstants.TestTenant3Id, true);
        var response3 = await PostAsJsonAsync($"/api/v1/superadmin/users/{userId1}/tenants", command3);
    ...
    public async Task AssignUserToTenant_TenantIsolation_ShouldNotAffectOtherTenantData()
    {
        ...
        await PostAsJsonAsync($"/api/v1/superadmin/users/{userId1}/tenants", command1);

        // User2 assigned to tenant 2  
        var command2 = CreateValidAssignCommand(userId2, TenantConstants.TestTenant2Id, true);
        await PostAsJsonAsync($"/api/v1/superadmin/users/{userId2}/tenants", command2);
    ...
    public async Task AssignUserToTenant_JsonSerialization_ShouldHandleCorrectly()
    {
        ...
        var content = new StringContent(json, System.Text.Encoding.UTF8, "application/json");
        var response = await Client.PostAsync($"/api/v1/superadmin/users/{userId1}/tenants", content);
    ...
    public async Task AssignUserToTenant_ConcurrentRequests_ShouldHandleGracefully()
    {
        ...
        var task1 = PostAsJsonAsync($"/api/v1/superadmin/users/{userId1}/tenants", command1);
        var task2 = PostAsJsonAsync($"/api/v1/superadmin/users/{userId1}/tenants", command2);
