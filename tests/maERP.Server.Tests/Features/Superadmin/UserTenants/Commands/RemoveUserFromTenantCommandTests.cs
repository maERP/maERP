...
namespace maERP.Server.Tests.Features.Superadmin.UserTenants.Commands;
...
public class RemoveUserFromTenantCommandTests : IDisposable
{
    ...
    public async Task RemoveUserFromTenant_WithValidData_ShouldSucceed()
    {
        ...
        var response = await Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/{TenantConstants.TestTenant2Id}");
    ...
    public async Task RemoveUserFromTenant_WithNonExistentAssignment_ShouldFail()
    {
        ...
        var response = await Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/{nonExistentTenantId}");
    ...
    public async Task RemoveUserFromTenant_WithNonExistentUser_ShouldFail()
    {
        ...
        var response = await Client.DeleteAsync($"/api/v1/superadmin/users/{nonExistentUserId}/tenants/{TenantConstants.TestTenant1Id}");
    ...
    public async Task RemoveUserFromTenant_WithDefaultTenant_ShouldSucceed()
    {
        ...
        var response = await Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/{TenantConstants.TestTenant1Id}");
    ...
    public async Task RemoveUserFromTenant_MultipleRemovals_ShouldHandleSequentially()
    {
        ...
        // Remove user1 from tenant 2
        var response1 = await Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/{TenantConstants.TestTenant2Id}");
        TestAssertions.AssertHttpStatusCode(response1, HttpStatusCode.OK);

        // Remove user1 from tenant 3
        var response2 = await Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/{TenantConstants.TestTenant3Id}");
    ...
    public async Task RemoveUserFromTenant_RemoveSameAssignmentTwice_ShouldFailSecondTime()
    {
        ...
        var response2 = await Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/{TenantConstants.TestTenant2Id}");
    ...
    public async Task RemoveUserFromTenant_WithInvalidTenantId_ShouldFail()
    {
        ...
        var response = await Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/{Guid.Empty}");
    ...
    public async Task RemoveUserFromTenant_ConcurrentRemovals_ShouldHandleGracefully()
    {
        ...
        var task1 = Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/{TenantConstants.TestTenant2Id}");
        var task2 = Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/{TenantConstants.TestTenant2Id}");
    ...
    public async Task RemoveUserFromTenant_UserDataIsolation_ShouldOnlyRemoveSpecificUserTenant()
    {
        ...
        // Remove user1 from tenant 3
        var response = await Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/{TenantConstants.TestTenant3Id}");
        TestAssertions.AssertHttpStatusCode(response, HttpStatusCode.OK);
    ...
    public async Task RemoveUserFromTenant_WithNegativeTenantId_ShouldFail()
    {
        ...
        var response = await Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/invalid-guid");
    ...
    public async Task RemoveUserFromTenant_RemoveAllAssignments_ShouldLeaveUserWithoutTenants()
    {
        ...
        var response = await Client.DeleteAsync($"/api/v1/superadmin/users/{userId3}/tenants/{TenantConstants.TestTenant1Id}");
    ...
    public async Task RemoveUserFromTenant_HttpMethodValidation_ShouldOnlyAllowDelete()
    {
        ...
        var postResponse = await Client.PostAsync($"/api/v1/superadmin/users/{userId1}/tenants/{TenantConstants.TestTenant2Id}", new StringContent(""));
        TestAssertions.AssertHttpStatusCode(postResponse, HttpStatusCode.MethodNotAllowed);

        // Try with PUT (should fail)  
        var putResponse = await Client.PutAsync($"/api/v1/superadmin/users/{userId1}/tenants/{TenantConstants.TestTenant2Id}", new StringContent(""));
        TestAssertions.AssertHttpStatusCode(putResponse, HttpStatusCode.MethodNotAllowed);

        // DELETE should work
        var deleteResponse = await Client.DeleteAsync($"/api/v1/superadmin/users/{userId1}/tenants/{TenantConstants.TestTenant2Id}");
