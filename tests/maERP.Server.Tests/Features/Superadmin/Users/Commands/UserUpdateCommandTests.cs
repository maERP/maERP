...
public class UserUpdateCommandTests : IDisposable
{
    ...
    public async Task UpdateUser_WithValidData_ShouldReturnNoContent()
    {
        ...
        var response = await PutAsJsonAsync($"/api/v1/superadmin/users/{userId1}", updateCommand);
    ...
    public async Task UpdateUser_WithNonExistentId_ShouldReturnNotFound()
    {
        ...
        var response = await PutAsJsonAsync($"/api/v1/superadmin/users/{nonExistentId}", updateCommand);
    ...
    public async Task UpdateUser_TenantIsolation_ShouldNotUpdateOtherTenantUsers()
    {
        ...
        var response = await PutAsJsonAsync($"/api/v1/superadmin/users/{userId2}", updateCommand);
    ...
    public async Task UpdateUser_WithInvalidJson_ShouldReturnBadRequest()
    {
        ...
        var response = await Client.PutAsync($"/api/v1/superadmin/users/{userId1}", content);
    ...
    public async Task UpdateUser_SelfWithoutManagePermission_ShouldSucceed()
    {
        ...
        var response = await PutAsJsonAsync($"/api/v1/superadmin/users/{currentUserId}", updateCommand);
