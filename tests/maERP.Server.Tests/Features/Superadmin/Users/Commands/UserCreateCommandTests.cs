...
public class UserCreateCommandTests : IDisposable
{
    ...
    public async Task CreateUser_WithValidData_ShouldReturnCreated()
    {
        ...
        var response = await PostAsJsonAsync("/api/v1/superadmin/users", userCommand);
    ...
    public async Task CreateUser_WithValidData_ShouldPersistInDatabase()
    {
        ...
        var getResponse = await Client.GetAsync($"/api/v1/superadmin/users/{result.Data}");
    ...
    public async Task CreateUser_WithDuplicateEmail_ShouldReturnBadRequest()
    {
        ...
        await PostAsJsonAsync("/api/v1/superadmin/users", firstUser);
        ...
        var response = await PostAsJsonAsync("/api/v1/superadmin/users", duplicateUser);
    ...
    public async Task CreateUser_TenantIsolation_ShouldCreateUserInCorrectTenant()
    {
        ...
        var response1 = await PostAsJsonAsync("/api/v1/superadmin/users", user1Command);
        ...
        var response2 = await PostAsJsonAsync("/api/v1/superadmin/users", user2Command);
    ...
    public async Task CreateUser_WithInvalidJson_ShouldReturnBadRequest()
    {
        ...
        var response = await Client.PostAsync("/api/v1/superadmin/users", content);
